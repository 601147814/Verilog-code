...
#
# version   : 
#           v1 - test, try to add wrapper need split
# Input     :
#   
# Output    : wrapper.v
#
...
#--------------main part------------#
    foreach my $wrapper(sort keys %wrapper_mem_hash){
       ...
       if ($mem     =~ /(crl|del|cul|drl|ssl|srl)(\d+x\d+)m/)        {$mem_size     = $2;}
...
sub gen_wrapper{
  my $wrapper = $_[0] ;
  if(-e "$chip/ram/rtl/both_12ff_ram_wrapper.pl"){}
  else{print"$chip/ram/rtl/both_11lpp_ram_wrapper.pl does bot exist!\n";exit();}
  if ($wrapper =~ /(.*(spsram|dprf_1clk|dprf_2clk))_(\d+)x(\d+)(_|x)/) {
    if ($5 eq 'x') {system "$chip/ram/rtl/both_12ff_ram_wrapper.pl $1 $3 $4 -bit_mask" ;}
    else           {system "$chip/ram/rtl/both_12ff_ram_wrapper.pl $1 $3 $4 " ;}
    } 
  else {
...
sub modify_same_size{
   ...
   if ($mem     =~ /(crl|del|cul|drl|ssl|srl)(\d+x\d+)m(\d+)b(\d+)w\dc(\d)/)        {
     $mem_type = $1 ;
     $mem_cm   = $3;
     $mem_bank = $4;
     $mem_cent = $5;
   ...
   while (<$wrapper_old_fh>){
        chomp ;
        s/sacul${process}(l|s)2p(\d+x\d+)m2b1w1c0p(\d)d0t0s2z1rw00/sacul${process}${1}2p$2m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
        s/sadrl${process}(s|l)2p(\d+x\d+)m2b1w1c0p(\d)d0t0s2z1rw00/sadrl${process}${1}2p$2m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
        if ($mem_type eq 'crl') {
          s/sacrl${process}(l|s)1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sacrl${process}${1}1p$2m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
          }
        elsif ($mem_type eq 'del'){
          s/sacrl${process}(l|s)1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sadel${process}${1}1p$2m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2sdz1rw01/;
        }
        elsif ($mem_type eq 'srl') {
          s/sacrl${process}s1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sasrl${process}l1p$1m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2z1rw00/;
          s/sacrl${process}l1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sasrl${process}u1p$1m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2z1rw00/;
          }
        elsif ($mem_type eq 'ssl'){
          s/sacrl${process}s1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sassl${process}l1p$1m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2sdz1rw00/;
          s/sacrl${process}l1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sassl${process}u1p$1m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2sdz1rw00/;
        }
...
sub modify_diff_size{
   ...
   my $mem_bank     = 9999;
   my $mem_cent     = 9999;
   if ($mem     =~ /(crl|del|cul|drl|ssl|srl).*p(\d+)x(\d+)m(\d+)b(\d+)w\dc(\d)/)        {
     $mem_type  = $1 ;
     $mem_depth = $2 ;
     $mem_width = $3 ;
     $mem_cm    = $4;
   ...
   while (<$wrapper_old_fh>){
        ...
        s/sacul${process}(l|s)2p(\d+x\d+)m2b1w1c0p(\d)d0t0s2z1rw00/sacul${process}${1}2p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
        s/sadrl${process}(s|l)2p(\d+x\d+)m2b1w1c0p(\d)d0t0s2z1rw00/sadrl${process}${1}2p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
        if ($mem_type eq 'crl') {
          s/sacrl${process}(l|s)1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sacrl${process}${1}1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2z1rw00/;
          }
        elsif ($mem_type eq 'del'){
          s/sacrl${process}(l|s)1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sadel${process}${1}1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$3d0t0s2sdz1rw01/;
          }
        elsif ($mem_type eq 'srl'){
          s/sacrl${process}s1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sasrl${process}l1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2z1rw00/;
          s/sacrl${process}l1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sasrl${process}u1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2z1rw00/;
          }
        elsif ($mem_type eq 'ssl'){
          s/sacrl${process}s1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sassl${process}l1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2sdz1rw00/;
          s/sacrl${process}l1p(\d+x\d+)m1b1w1c0p(\d)d0t0s2z1rw00/sassl${process}u1p${mem_depth}x${mem_width}m${mem_cm}b${mem_bank}w1c${mem_cent}p$2d0t0s2sdz1rw00/;
          }
